...
contract SupplyChain {
  ...
  /* Create a modifer that checks if the msg.sender is the owner of the contract */
    modifier verifyCaller (address _address) { require(_address == msg.sender); _;}
    ...
    function addItem(string _name, uint _price) public returns(bool) {
        ...
        items[skuCount] = Item({name: _name, sku: skuCount, price: _price,
                                state: State.ForSale, buyer: 0, seller: msg.sender});
        skuCount = skuCount + 1;
        return true;
    }
